 ...
 * Description: Display real-time whale wallet movements from 19 EVM chains on your WordPress site.
 * Version: 1.2.0
 * Author: CryptoPulse
...
add_shortcode('cryptopulse_wallet', function($atts) {
    ...
    $html .= '<div class="cp-footer">Scans 19 EVM chains · <a href="https://cryptopulse.uno" target="_blank">CryptoPulse</a></div>';
    $html .= '</div>';
    return $html;
});
...
class CryptoPulse_Widget extends WP_Widget {
    public function __construct() {
        parent::__construct('cryptopulse_widget', 'CryptoPulse Whales', ['description' => 'Show recent whale movements from 19 chains']);
    }
